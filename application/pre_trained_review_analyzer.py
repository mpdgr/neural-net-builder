...
"""
Uses pre-trained network to predict movie review sentiment. Run script to open input window and write or
paste review. The review will be fed to the network and result will be shown.
Uses network trained in movie_reviews_sentiment_measure.py script.
"""
